...
import MAKRA from './sources/makra'
...
Object.defineProperty(sources, 'makra', { get: ()=> MAKRA })
...
function source(params){
    return params.source && sources[params.source] ? sources[params.source] : sources.makra
}

function availableDiscovery(){
    let list   = []
    let active = Storage.get('source','makra')

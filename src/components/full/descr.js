...
class Descriptiopn extends Emit{
    ...
    create(){
        ...
        let genres    = Array.isArray(this.card.genres) ? this.card.genres : []
        let companies = Array.isArray(this.card.production_companies) ? this.card.production_companies : []
        ...
        if(genres.length){
            tags.append(this.tag(Lang.translate('full_genre'), genres, (genre)=>{
                Activity.push({
                    url: genre.url || media,
        ...
        if(companies.length){
            tags.append(this.tag(Lang.translate('full_production'), companies, (company)=>{
